...
const { validateStudentRegistration, validateStudentSearch, validateLRN, validateStudentId, validateStudentUpdate, validateUpdateSF10, validateDeleteSF10 } = require('../middleware/studentValidation');
