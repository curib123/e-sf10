 ...
 return (
  <div className="container-fluid my-1">
    ...
    <div className="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-4">
      <div className="position-relative flex-grow-1" style={{ maxWidth: "600px" }}>
        <FaSearch
          ...
          style={{
            ...
            color: "#6c757d", // muted gray for icon
            fontSize: "20px",
          }}
        />
        <input
      ...
      <Link
        to="/add_student"
        className="btn d-flex align-items-center gap-2 px-4 py-2 rounded-pill shadow text-white fw-semibold"
        style={{
          background: "linear-gradient(135deg, #28a745, #85e89d)", // bootstrap green + lighter
          boxShadow: "0 4px 12px rgba(40, 167, 69, 0.5)",
          border: "none",
          transition: "background 0.3s ease",
        }}
        onMouseEnter={(e) =>
          (e.currentTarget.style.background = "linear-gradient(135deg, #218838, #70d870)")
        }
        onMouseLeave={(e) =>
          (e.currentTarget.style.background = "linear-gradient(135deg, #28a745, #85e89d)")
        }
      >
        <FaPlus />
        Add Student
              ...
              {searchLoading ? (
                ...
                students.map((student) => (
                  <tr
                    ...
                    onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#e9f7ef")} // light green hover
                    ...
                    <td>
                      <div className="d-flex flex-wrap gap-3 justify-content-center">
                        <Link
                          ...
                          style={{ minWidth: "70px", textDecoration: "none", transition: "background-color 0.3s" }}
                          onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = "#28a745", e.currentTarget.style.color = "#fff")}
