...
// StudentInformation.modern.jsx — Bootstrap-only, clean + modern UI
// - URL-synced query params (q, gender, page, size, sort)
// - Debounced search, client-side sort for search results
// - Paged fetch for normal list
// - Soft glass card surfaces, gradient toolbar, compact controls
// - Accessible buttons, sticky table header, empty state
import React, {
  useCallback,
  useEffect,
  useMemo,
...
const StudentInformation = () => {
  ...
  return (
    <div className="container-xxl py-4 py-lg-5">
      {/* Local styles (scoped by unique class names) */}
      <style>{`
        .si-gradient-bar {
          background: linear-gradient(135deg, rgba(0,123,255,.12), rgba(13,202,240,.12));
          border-radius: 24px;
        ...
        .si-input .input-group-text { background: transparent; border-right: 0; }
        .si-input input { border-left: 0; }
        .si-badge {
          font-weight: 600;
          letter-spacing: .2px;
        }
        thead.sticky-top { z-index: 1; }
        .si-action-gap > * { min-width: 110px; }
        .si-empty-emoji { font-size: 40px; line-height: 1; }
      `}</style>

      {/* Header */}
      <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-3 mb-lg-4">
        <div className="p-3 si-gradient-bar w-100">
      ...
      <div className="card si-card mb-3">
        <div className="card-body d-flex flex-column gap-3">
          {/* Search */}
          <div className="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center gap-2">
            <div className="input-group si-input">
              ...
              />
              {searchQuery && (
                <button className="btn btn-outline-secondary" onClick={onClearSearch} aria-label="Clear search">
                  <FaTimes />
                </button>
              )}
            </div>
        ...
        <div className="card-body p-0">
          {searchLoading ? (
            ...
            <div className="p-5 text-center">
              <div className="si-empty-emoji">📘</div>
                ...
                <table className="table table-hover align-middle mb-0">
                  <thead className="table-light sticky-top">
                    <tr>
                      ...
                      <ThSortable col="status" sort={sort} setSort={setSort} width={170}>Status</ThSortable>
                      ...
                      return (
                        <tr key={s.lrn}>
                          ...
                          <td className="text-nowrap">
                            <span className={`badge bg-${badgeVariant} si-badge`}>{status}</span>
                          </td>
                          <td className="text-end">
                            <div className="d-inline-flex flex-nowrap gap-1 si-action-gap">
                              <Link
              ...
              <div className="modal-body" style={{ maxHeight: '65vh', overflowY: 'auto' }}>
                ...
                <div className="alert alert-info mt-3 small mb-0">
                  ...
                  <ul className="mb-0 mt-1">
                    ...
                    <li>
                      Gender: <code>Male</code> or <code>Female</code>.
                    </li>
                  </ul>
                </div>
                <div className="mt-3">
