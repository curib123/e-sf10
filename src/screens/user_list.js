...
// Prefer env URL; fall back to empty string if not set
...
const UserList = () => {
  ...
  useEffect(() => {
    ...
    let filtered = users.filter((user) => {
      ...
      const matchesRole =
        selectedRole === "" ||
        rolesString.includes(selectedRole.toLowerCase());
        ...
        <div className="card-body">
          <div className="row g-3 align-items-center">
            ...
            <div className="col-md-4 d-flex justify-content-end gap-2">
              <Link
                to="/create_roles"
                className={`btn btn-primary shadow-sm text-nowrap px-3 ${
                  permissions.manage_roles ? "" : "disabled"
                }`}
              >
              ...
              <Link
                to="/add_user"
                className={`btn btn-primary shadow-sm text-nowrap px-3 ${
                  permissions.manage_users ? "" : "disabled"
                }`}
              >
                <FaPlus className="me-1" />
                Create User Account
            ...
            <table className="table table-bordered table-striped table-hover align-middle text-center mb-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <span className="badge bg-success p-2 px-3 rounded-pill text-nowrap">
                      Logged In
                    </span>
                  </td>
                </tr>
          ...
          <table className="table table-bordered table-striped table-hover align-middle text-center mb-0">
            <thead className="table-light">
              <tr>
                ...
                <th>Roles</th>
                <th>Created At</th>
                <th style={{ minWidth: 330 }} className="text-end">
                  Actions
                </th>
              </tr>
            </thead>
                      ...
                      <td className="text-end">
                        <div className="d-flex justify-content-end gap-2 flex-nowrap">
                          <Link
                            ...
                            className={`btn btn-sm btn-outline-primary px-3 text-nowrap ${
                              permissions.manage_users ? "" : "disabled"
                            }`}
                            title="Edit user"
                          >
                          ...
                          <button
                            className={`btn btn-sm btn-outline-danger px-3 text-nowrap ${
                              permissions.manage_users ? "" : "disabled"
                            }`}
                            disabled={!permissions.manage_users || isSelf}
                            onClick={() => {
                              setUserToDelete(u.user_id);
                              setShowConfirm(true);
                            }}
                            title={
                              isSelf
                          ...
                          <Link
                            ...
                            className={`btn btn-sm btn-outline-warning px-3 text-nowrap ${
                              permissions.manage_permissions ? "" : "disabled"
                            }`}
