...
const RequestTransferForm = () => {
  ...
  return (
    <div className="container-fluid py-5">
      <div className="card shadow-sm border-0 mx-auto" style={{ maxWidth: "1000px" }}>
        <div className="card-body p-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3 position-relative">
              ...
              />
              {showSuggestions && (
                <ul className="list-group position-absolute w-100 z-index-100" style={{ top: '100%', maxHeight: '200px', overflowY: 'auto' }}>
