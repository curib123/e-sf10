    ...
    (async () => {
      try {
        ...
        if (data?.success && data?.schoolYear) {
          ...
          setIsActive(sy.is_active === 1 || sy.is_active === true);
        } else {
        ...
        <div className="card-body p-4 p-lg-5">
          ...
          {isEdit && !isActive && (
            <div className="alert alert-warning d-flex align-items-start gap-2 py-2" role="alert">
              ...
              <div className="small">
                This school year is currently <strong>inactive</strong>. Activate it from the appropriate admin screen when it becomes the official working year.
              </div>
            </div>
          )}
