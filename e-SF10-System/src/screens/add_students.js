...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare payload without student_id and created_at/updated_at
    const {
      student_id,
      created_at,
      updated_at,
    ...
    try {
      ...
      if (onSubmit) {
        // Provide updated student data including student_id if available
        onSubmit(data.student || payload);
      }

      if (!student_id) {
        // Clear form after adding new student
